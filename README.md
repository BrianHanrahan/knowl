...
- Use the **Input** and **Output** language dropdowns to guide Whisper. Choose *Auto-detect* to let Whisper infer the input language. (Translations are limited to English output when supported.)
