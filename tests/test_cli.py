...
class TestContextInspect:
    ...
    def test_inspect_with_index(self):
        # INDEX.md lives in the parent of GLOBAL_DIR
        index_path = store.GLOBAL_DIR.resolve().parent / "INDEX.md"
        index_path.write_text("# Context Index\nAvailable files listed here.")
        output = run_cli("context", "inspect")
        assert "global/INDEX.md" in output
